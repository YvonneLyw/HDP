...
class HieraDiffusionPolicyD3PFusionBplusQ(HieraDiffusionPolicy):
    """
    ...
    Notes:
      ...
      - Q loss follows the global eta for all branches in this BplusQ variant.
    """
    ...
    def _compute_loss_actor_from_cond(
        ...
        # ******** q loss ********
        # In this BplusQ variant, every branch uses the global eta.
        if self.eta != 0:
